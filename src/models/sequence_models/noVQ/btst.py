...
from src.models.BTST.conv_ops import VmapBasicConv
from src.models.BTST.diagonal_ssm import init_BTSTSSM
from src.models.base import ResNetEncoder, ResNetDecoder
from src.models.BTST.layers import StackedLayers
...
class BTST_NOVQ(nn.Module):
    ...
    def setup(self):
        ...
        # Sequence Model
        self.ssm = init_BTSTSSM(config.ssm['ssm_size'],
                                  config.ssm['blocks'],
                                  ...
                                  config.ssm['input_size'],
                                  config.ssm['basis_type'],
                                  config.ssm['mini'])
